-- ArcBase OUTREACH SYSTEM — EMAIL CHANNEL — ADDITIVE ONLY. Paste-into-the-SQL-editor
-- twin of supabase/migrations/20260803120000_outreach_email_channel.sql (the two are
-- kept byte-identical by supabase/sql-sync.test.ts).
--
...
--
-- APPLY BY PASTING THIS SCRIPT INTO THE SUPABASE SQL EDITOR. Do not `db push` — see
-- the Report Links and Connection Count runbooks for why the CLI path has burned this
-- repo before.
