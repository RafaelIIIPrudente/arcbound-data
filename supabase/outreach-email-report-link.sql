-- ArcBase OUTREACH EMAIL CHANNEL → REPORT LINK (S4, 2026-08-10) —
-- paste-into-the-SQL-editor twin of
-- supabase/migrations/20260810120000_outreach_email_report_link.sql (the two
-- are kept byte-identical by supabase/sql-sync.test.ts).
--
...
-- Until it is applied, the Client's report keeps showing only the five
-- LinkedIn-era figures — this script is additive, so that is never a break.
