-- ArcBase OUTREACH SYSTEM — ADDITIVE ONLY. Paste-into-the-SQL-editor twin of
-- supabase/migrations/20260727130000_outreach_system.sql (the two are kept
...
-- see the Report Links and Connection Count runbooks for why the CLI path has
